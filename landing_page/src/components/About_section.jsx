...
export default function About_section() {
  ...
  return (
    <div id="About" className=" w-screen flex justify-center items-center  px-4 sm:px-6 lg:px-8">
      <div className=" w-screen  p-10">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center ">
          ...
          <div className="space-y-6">
            ...
            {text ? (
              <p className="text-xl">
                NBA TECH, registered on 11th July 2024, is led by a seasoned IT
                and Cybersecurity expert with 25 years of experience. Our
                mission is to bring innovative, secure, and future-forward
                solutions to businesses across industries, helping them embrace
                technology while staying ahead of the cyber threats of tomorrow.
                <p>
                At NBA TECH, we are committed to not only addressing current cyber threats but also anticipating the challenges of tomorrow, enabling organizations to embrace innovation with confidence and resilience. Through our expertise and dedication, we help businesses across diverse industries navigate the complexities of technology while safeguarding their digital assets.
                </p>
              </p>
            ) : (
              <p className="text-xl">
